    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
                <div class="box-body">
                    <?=form_open('Dashboard/addGymMember')?>
                        <div class="col-md-10 col-md-offset-1">
                            <div class="form-group">
                                <input type="text" class="form-control" name="member_name" placeholder="Member Name">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control datepicker" name="member_from" placeholder="Member from">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control datepicker" name="member_till" placeholder="Member till">
                            </div>
